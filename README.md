...
git clone https://github.com/alenjoo/WeShop.git  
cd WeShop  
flutter run  

Usage

Open the app and select the store you're shopping at.
Scan the QR codes of the products you wish to purchase.
